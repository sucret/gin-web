...
const userNav = options => {
  const nav = [
    ...
    // {
    //   name: 'EditStation',
    //   path: '/shop/station/edit/:station_id',
    //   parentId: 20001,
    //   id: 20006,
    //   meta: {
    //     title: '编辑工位',
    ...
    {
      name: 'SaveNode',
      path: '/node/save/:node_id/:parent_node_id',
      parentId: 20301,
      id: 20303,
      meta: {
        title: '新增节点',
...
Mock.mock(/\/admin\/profile/, 'get', info)
Mock.mock(/\/admin\/user\/nav/, 'get', userNav)

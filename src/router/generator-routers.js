...
const constantRouterComponents = {
  ...
  RoleList: () => import('@/views/role/list'),
  RolePermission: () => import('@/views/role/permission'),

  // node
  Node: () => import('@/views/node/index'),
  NodeList: () => import('@/views/node/list'),
  SaveNode: () => import('@/views/node/save'),

  // admin
  Admin: () => import('@/views/admin/index'),
  AdminList: () => import('@/views/admin/list'),
  SaveAdmin: () => import('@/views/admin/save'),
  EditAdmin: () => import('@/views/admin/save'),
